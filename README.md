...
Maintenant que nous ne sommes plus des étrangers, même votre mère ne serait d'accord pour que vous me parliez !
...
Livre n'est pas purement scienfifique. C'est un ensemble d'opinions receullils via des conversations avec des programmeurs, en ligne ou hors ligne, de la lecture sur le sommeil, et j'en passe. Si vous voulez voir l'aspect scientifique de la chose, vous devriez aller parler à ces merveilleur gens qui recherchent ce genre de chose afin de vivre.

<!-- ## How finished is Book -->

## A quel point est fini Livre
...
Ce livre est encore un travail en cours, si vous lisez ça via le [repo GitHub](https://github.com/Swizec/nightowls), c'est merveilleux ! Assurez vous de me donner votre avis, les Issues GitHub existent pour une raison.
...
J'appelle ça version 0.3. La partie la plus intéressante actuellement est **à propos de l'immersion**, avec **Travailler avec des programmeurs** qui arrive derrière. **Pourquoi les programmeurs travaillent la nuit** contient quelques 
...
Si vous aimez les données, vous devriez définitivement aller voir la partie Statistiques de **Pourquoi les programmeurs travaillent ils la nuit ?**, elle contient une analyse de plus de 500 000 repositories github.
...
J'ai passé ces 16 dernières années de ma vie soit attaché à un ordinateur ou à parler a des autres programeurs. Je ne suis pas certain que ça me rend capable de parler des programmeurs et de leurs habitudes, mais je serais maudit si je n'essaye pas.
...
Il y a quelque temps j'ai écrit un essai _[Why programmers work at night (en anglais)](http://swizec.com/blog/why-programmers-work-at-night/swizec/3198)_, qui a obtenu un retour génial. Beaucoup d'emails aussi. Ce livre est une expension de cet essai en une forme qui sera (j'espère) utile ou au moins intéressante et distrayante (?).
...
Couverture du livre fait à la courtoisie de [@ponywithhiccups](https://twitter.com/ponywithhiccups)
